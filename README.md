...
```
redseek-rescue/
├── PRESENTATION.md              # Professional overview (Opus-generated)
├── build.sh                     # ISO build script
├── config/
│   ├── hermes-config.yaml       # Hermes agent config
│   ├── rescue-prompt.txt        # System prompt for the AI rescue agent
│   └── skills/                  # Hermes skills loaded at boot
│       ├── redseek-user-guide/  # User-facing guide
│       └── redseek-scripts-guide/# Script usage guide
├── scripts/
...
> 📖 **Want a detailed overview?** See [PRESENTATION.md](PRESENTATION.md) — a professional breakdown of the architecture, components, security measures, and more (generated by Claude Opus 4.6).
